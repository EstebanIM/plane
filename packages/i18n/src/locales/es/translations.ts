...
export default {
  ...
  workspace_creation: {
    ...
    request_email: {
      ...
      body:
        "Hola administrador(es) de instancia,\n" +
        "\n" +
  ...
  account_settings: {
    ...
    notifications: {
      ...
      description: "Mantente al tanto de las tareas a las que estás suscrito. Activa esto para recibir avisos.",
    },
    security: {
      heading: "Seguridad",
    },
    api_tokens: {
      ...
      description: "Genera tokens de API seguros para integrar tus datos con sistemas y aplicaciones externas.",
    },
    activity: {
      heading: "Actividad",
      description: "Consulta tus acciones y cambios recientes en todos los proyectos y tareas.",
    },
  },
  workspace_settings: {
    ...
    settings: {
      ...
      billing_and_plans: {
        ...
        description: "Elige tu plan, administra suscripciones y actualízalo fácilmente cuando tus necesidades crezcan.",
      },
      exports: {
        title: "Exportaciones",
        ...
        description:
          "Exporta los datos de tus proyectos en distintos formatos y accede al historial con enlaces de descarga.",
      ...
      webhooks: {
        ...
        heading: "Webhooks",
        description: "Automatiza notificaciones a servicios externos cuando ocurran eventos del proyecto.",
      },
      api_tokens: {
        title: "Tokens de API",
  ...
  project_settings: {
    ...
    states: {
      ...
      heading: "Estados",
      description: "Define y personaliza los estados del flujo para seguir el progreso de tus tareas.",
    },
    labels: {
      ...
      heading: "Etiquetas",
      description: "Crea etiquetas personalizadas para categorizar y organizar tus tareas.",
    },
    estimates: {
      label: "Estimaciones",
    ...
    automations: {
      ...
      description: "Configura acciones automatizadas para agilizar la gestión del proyecto y reducir tareas manuales.",
    },
    empty_state: {
      labels: {
  ...
  timezone_setting: "Configuración actual de zona horaria.",
  language_setting: "Selecciona el idioma usado en la interfaz.",
  settings_moved_to_preferences: "Las opciones de zona horaria e idioma se movieron a preferencias.",
  go_to_preferences: "Ir a preferencias",
  settings_description:
    "Administra las preferencias de tu cuenta, espacio de trabajo y proyectos desde un solo lugar. Cambia de pestaña para configurar fácilmente.",
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        ...
        add_to_cycle: "Agregar al ciclo",
        add_to_modules: "Agregar a módulos",
        add_labels: "Agregar etiquetas",
        subscribe: "Suscribirme a las notificaciones",
        unsubscribe: "Cancelar suscripción a notificaciones",
        delete: "Eliminar",
        copy_id: "Copiar ID",
        copy_id_toast_success: "ID de la tarea copiado al portapapeles.",
        copy_id_toast_error: "Ocurrió un error al copiar el ID de la tarea.",
        copy_title: "Copiar título",
        copy_title_toast_success: "Título de la tarea copiado al portapapeles.",
        copy_title_toast_error: "Ocurrió un error al copiar el título de la tarea.",
        copy_url: "Copiar URL",
        copy_url_toast_success: "URL de la tarea copiada al portapapeles.",
        copy_url_toast_error: "Ocurrió un error al copiar la URL de la tarea.",
      },
      cycle: {
        ...
        copy_url_toast_error: "Ocurrió un error al copiar la URL del ciclo.",
      },
      module: {
        title: "Acciones de módulo",
        indicator: "Módulo",
        add_remove_members: "Agregar/quitar miembros",
        change_status: "Cambiar estado",
        add_to_favorites: "Agregar a favoritos",
        remove_from_favorites: "Quitar de favoritos",
        copy_url: "Copiar URL",
        copy_url_toast_success: "URL del módulo copiada al portapapeles.",
        copy_url_toast_error: "Ocurrió un error al copiar la URL del módulo.",
      },
      page: {
        ...
        copy_url_toast_error: "Ocurrió un error al copiar la URL de la página.",
      },
    },
    creation_actions: {
      create_work_item: "Nueva tarea",
    ...
    navigation_actions: {
      ...
      nav_account_settings: "Ir a la configuración de la cuenta",
      open_project: "Abrir un proyecto",
      nav_projects_list: "Ir a la lista de proyectos",
      nav_all_workspace_work_items: "Ir a todas las tareas",
      nav_assigned_workspace_work_items: "Ir a tareas asignadas",
      nav_created_workspace_work_items: "Ir a tareas creadas",
      nav_subscribed_workspace_work_items: "Ir a tareas suscritas",
      nav_workspace_analytics: "Ir a las analíticas del espacio de trabajo",
      nav_workspace_drafts: "Ir a los borradores del espacio de trabajo",
      nav_workspace_archives: "Ir a los archivos del espacio de trabajo",
      open_workspace_setting: "Abrir una configuración del espacio de trabajo",
      nav_workspace_settings: "Ir a la configuración del espacio de trabajo",
      nav_project_work_items: "Ir a las tareas",
      open_project_cycle: "Abrir un ciclo",
      nav_project_cycles: "Ir a los ciclos",
      open_project_module: "Abrir un módulo",
      nav_project_modules: "Ir a los módulos",
      open_project_view: "Abrir una vista del proyecto",
      nav_project_views: "Ir a las vistas del proyecto",
      nav_project_pages: "Ir a las páginas",
      nav_project_intake: "Ir a la bandeja de entrada del proyecto",
      nav_project_archives: "Ir a los archivos del proyecto",
      open_project_setting: "Abrir una configuración del proyecto",
      nav_project_settings: "Ir a la configuración del proyecto",
    },
    account_actions: {
      sign_out: "Cerrar sesión",
      workspace_invites: "Invitaciones del espacio de trabajo",
    },
    miscellaneous_actions: {
      toggle_app_sidebar: "Alternar barra lateral de la aplicación",
      copy_current_page_url: "Copiar la URL de la página actual",
      copy_current_page_url_toast_success: "URL de la página actual copiada al portapapeles.",
      copy_current_page_url_toast_error: "Ocurrió un error al copiar la URL de la página actual.",
      focus_top_nav_search: "Enfocar el campo de búsqueda",
    },
    preferences_actions: {
      update_theme: "Cambiar el tema de la interfaz",
      update_timezone: "Cambiar la zona horaria",
      update_start_of_week: "Cambiar el primer día de la semana",
      update_language: "Cambiar el idioma de la interfaz",
      toast: {
        theme: {
          success: "Tema actualizado correctamente.",
          error: "No se pudo actualizar el tema. Intenta nuevamente.",
        },
        timezone: {
          success: "Zona horaria actualizada correctamente.",
          error: "No se pudo actualizar la zona horaria. Intenta nuevamente.",
        },
        generic: {
          success: "Preferencias actualizadas correctamente.",
          error: "No se pudieron actualizar las preferencias. Intenta nuevamente.",
        },
      },
    },
    help_actions: {
      open_keyboard_shortcuts: "Abrir atajos de teclado",
      open_plane_documentation: "Abrir la documentación de Plane",
    ...
    page_placeholders: {
      ...
      update_work_item_cycle: "Agregar al ciclo",
      update_work_item_module: "Agregar a módulos",
      update_work_item_labels: "Agregar etiquetas",
    ...
    footer: {
      workspace_level: "Nivel del espacio de trabajo",
    },
    group_titles: {
  ...
  personal: "Personal",
  accordion_navigation_control: "Navegación lateral en acordeón",
  ...
  enter_number_of_projects: "Ingresa el número de proyectos",
  pin: "Anclar",
  unpin: "Desanclar",
};
